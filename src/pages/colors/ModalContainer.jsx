...
import { addColorsService } from "../../services/colors";
...
const Modalcontainer = ({ isModalOpen, handleModalClose,setForceRender}) => {
  ...
  const handleAddColor = async (data) => {
    try {
      ...
      const res = await addColorsService(data);
      ...
      >
        ...
        <div className="modal-body ">
          ...
          <TextInput
            ...
            validation={{ required: "Color name is required" }}
            errors={errors}
          />
  <TextInput
            ...
            validation={{ required: "Color code is required" }}
            errors={errors}
          />
